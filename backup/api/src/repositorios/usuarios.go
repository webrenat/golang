...
// Criar insere um usuário no banco dados
func (repositorio Usuarios) Criar(usuario modelos.Usuario) (uint64, error) {
	...
	ultimoIDInserdo, erro := resultado.LastInsertId()
	if erro != nil {
		return 0, erro
	}

	return uint64(ultimoIDInserdo), nil
}
...
// PararDeSeguir permite que um usuario para de seguir o outro
